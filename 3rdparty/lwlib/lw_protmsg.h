...
typedef vec_t(ProtMsgLightFacet_t) ProtMsgLightFacetSeq_t;
...
typedef vec_t(ProtMsgLightDoor_t) ProtMsgLightDoorSeq_t;
...
typedef vec_t(ProtMsgLightInfo_t) ProtMsgLightInfoSeq_t;
...
typedef vec_t(ProtMsgLightMap_t) ProtMsgLightMapSeq_t;
